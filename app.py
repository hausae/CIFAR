...
#  CIFAR-10 Image Classifier — Streamlit + ONNX Runtime
# ============================================================
...
<div style="background:#fff;border:1px solid var(--border);border-radius:var(--r);
  ...
  <div style="display:flex;gap:7px;flex-wrap:wrap">
    <span class="chip chip-dark">CNN · ONNX Runtime</span>
...
<div style="background:#fff;border:1px solid var(--border);border-radius:var(--r);padding:20px 24px;margin-top:8px">
  <span class="sec-lbl">How to fix — run this in your Jupyter notebook</span>
  <p style="font-size:13px;margin-bottom:12px">
    Add these two cells at the end of your notebook and run them.
    Then upload <code>cifar10_model.onnx</code> to your GitHub repo.
  </p>
  <code style="background:var(--dark);color:var(--gold-lt);padding:10px 16px;border-radius:8px;
               display:block;font-size:12px;line-height:1.8;white-space:pre">
pip install tf2onnx
...
onnx.save(model_proto, "cifar10_model.onnx")</code>
</div>""", unsafe_allow_html=True)
    st.stop()
